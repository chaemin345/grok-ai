...
<body>
  ...
  <div class="meta">생성 시각: ${new Date(result.timestamp).toLocaleString("ko-KR")} · 이슈 ${result.issues.length}건${result.contextCheckEnabled ? " · 문맥검사 포함" : ""}</div>
  ...
  <div class="footer">
    ...
    Generated by Grok AI / Lunia.ai MVP
  </div>
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <div style={{ fontSize: 12, opacity: 0.6 }}>B2B Legal AI · MVP</div>
      </header>

      <main style={{ flex: 1, maxWidth: 920, width: "100%", margin: "0 auto", padding: "32px 20px 60px" }}>
        {/* Hero */}
        <section style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: "#64748b", margin: 0, fontSize: 15, lineHeight: 1.6 }}>
            잘못된 법령·조문 인용에 <strong style={{ color: "#dc2626" }}>빨간 밑줄</strong>과{" "}
        ...
        >
          ...
          <textarea
            ...
            placeholder="법률 보고서·의견서·계약서 초안을 붙여넣으세요…\n예: 민법 제750조에 따라 책임이 있다."
            rows={11}
            style={{
              width: "100%",
              padding: 14,
          ...
          >
            ...
            >
              ...
              />
              문맥·논리 검사 <span style={{ color: "#94a3b8" }}>(Claude API)</span>
            </label>
        ...
        {result && (
          <section ref={reportRef}>
            ...
            >
              <div>
                <div style={{ fontSize: 13, color: "#64748b", marginBottom: 4 }}>검증 점수</div>
                <div
                  style={{
                    fontSize: 48,
                    fontWeight: 800,
              ...
              <div style={{ flex: 1, minWidth: 180 }}>
                <div style={{ fontSize: 13, color: "#64748b", marginBottom: 8 }}>이슈 요약</div>
                ...
                {result.contextCheckEnabled && (
                  <div style={{ marginTop: 8, fontSize: 12, color: "#6366f1" }}>문맥·논리 검사 포함</div>
                )}
              </div>
            ...
            >
              <h2 style={{ fontSize: 15, fontWeight: 700, margin: "0 0 14px" }}>밑줄 결과</h2>
              <div
                style={{
                  background: "#f8fafc",
            ...
            {result.issues.length > 0 && (
              ...
              >
                <h2 style={{ fontSize: 15, fontWeight: 700, margin: "0 0 14px" }}>이슈 상세</h2>
      ...
      >
        Lunia.ai · 국가법령정보센터 API 기반 · 본 서비스는 참고용이며 법적 자문을 대체하지 않습니다.
        <br />
        <span style={{ opacity: 0.7 }}>Powered by Grok AI · B2B Legal Tech MVP</span>
      </footer>
