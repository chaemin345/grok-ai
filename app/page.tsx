...
<body>
  ...
  <div class="meta">생성 시각: ${new Date(result.timestamp).toLocaleString("ko-KR")} · 이슈 ${result.issues.length}건${result.contextCheckEnabled ? " · 문맥검사 포함" : ""} · v${result.version || "1.0.0"}</div>
  ...
  <div class="footer">
    ...
    Generated by Lunia.ai v1.0 · B2B Legal Tech
  </div>
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <div style={{ fontSize: 12, opacity: 0.6 }}>B2B Legal AI · v1.0</div>
      </header>
      ...
      >
        ...
        <span style={{ opacity: 0.7 }}>
          B2B Legal Tech · v1.0 · Powered by Grok AI
        </span>
      </footer>
