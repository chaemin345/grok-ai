...
1. **빨간 밑줄 + 각주**가 핵심이다. AI가 문장을 고쳐 쓰지 않는다. 잘못 쓰인 판례를 찾아서 빨간 밑줄을 처준다. 신뢰도를 높이기 위해 각주를 달아준다.
...
- [x] 클라이언트사이드 검증 히스토리 (localStorage, 최대 12건)
  - 검증 실행 후 자동 저장
  - 최근 기록 패널에서 불러오기 / 전체 삭제
  - 서버로 전송하지 않음 (프라이버시 전용)

## 비즈니스 포지셔닝

- **타깃**: 법무법인, 기업 법무팀, 법률 스타트업 (B2B)
- **유료 전환 후보**: 배치 업로드, 서버 히스토리, 판례 검증, 팀 시팅, SLA, 자주 사용 유저
